<?php
/**
 * Grand_Construction Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Grand_Construction_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Grand_Construction_Repeater_Setting extends WP_Customize_Setting {
